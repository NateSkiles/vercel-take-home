...
Hoping on a call also allows me to record and take notes, which could be useful if this is a platform issue.

On the call, I would walk through my questions from the previous email and get a better understanding of the issue. If it is a platform issue, I would have the information I need to submit a bug report or recreate the issue outside the user's environment.
